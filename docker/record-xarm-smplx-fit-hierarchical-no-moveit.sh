...
OUT_DIR="${1:-/tmp/xarm_smplx_fit_hierarchical_no_moveit}"
RECORD_SECONDS="${2:-36}"

export RETARGET_CONFIG="${RETARGET_CONFIG:-/tmp/xarm7-smplx-fit-retarget-hierarchical-no-moveit-config.json}"
...
export RETARGET_PREPOSE_DURATION="${RETARGET_PREPOSE_DURATION:-4.5}"
export RETARGET_POST_PREPOSE_SETTLE_SECONDS="${RETARGET_POST_PREPOSE_SETTLE_SECONDS:-1.0}"
