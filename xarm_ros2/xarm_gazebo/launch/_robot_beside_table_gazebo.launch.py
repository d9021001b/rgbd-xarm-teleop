...
def launch_setup(context, *args, **kwargs):
    ...
    add_soft_gripper = LaunchConfiguration('add_soft_gripper', default=False)
    ...
    if not moveit_config_dict:
        ...
        robot_description = {
            'robot_description': get_xacro_content(
                ...
                add_soft_gripper=add_soft_gripper,
    ...
    if gz_type == 'gz':
        ...
        args = [
            ...
            # Tripod-mounted Intel RealSense D455 target camera (GZ -> ROS2)
            '/tripod_d455/depth/image@sensor_msgs/msg/Image@gz.msgs.Image',
            '/tripod_d455/depth/camera_info@sensor_msgs/msg/CameraInfo@gz.msgs.CameraInfo',
            '/tripod_d455/depth/depth_image@sensor_msgs/msg/Image@gz.msgs.Image',
            '/tripod_d455/depth/points@sensor_msgs/msg/PointCloud2@gz.msgs.PointCloudPacked',
            '/retarget_closeup/image@sensor_msgs/msg/Image@gz.msgs.Image',
